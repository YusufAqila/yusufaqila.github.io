...
!(function ($) {
  ...
  $.fn.onepage_scroll = function (options) {
    ...
    $('.topage1').click(function () {
      if (!$('body').hasClass('disabled-onepage-scroll')) event.preventDefault();
      el.moveTo(1);
      $('.topage1').attr('id', 'active');
      $('.topage2').removeAttr('id', 'active');
      $('.topage3').removeAttr('id', 'active');
      $('.topage4').removeAttr('id', 'active');
    });
    $('.topage2').click(function () {
      if (!$('body').hasClass('disabled-onepage-scroll')) event.preventDefault();
      el.moveTo(2);
      $('.topage2').attr('id', 'active');
      $('.topage1').removeAttr('id', 'active');
      $('.topage3').removeAttr('id', 'active');
      $('.topage4').removeAttr('id', 'active');
    });
